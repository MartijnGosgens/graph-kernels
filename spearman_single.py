...
all_interpolators = [interpolate_ER_GCG, interpolate_ER_inhomogeneous, interpolate_ER_triangular,interpolate_ER_GRG_torus, interpolate_GRG_torus_circle,interpolate_ER_PPM]
